...
class FlatListItem extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.item.sender.toString() == UserID) {
...
export default class FeedbackReply extends React.Component {
    ...
    submit() {
        if (this.state.content.trim() !== '') {
            ...
            AddSubFeedback(this.state.content, DatePost, this.state.supervisorID, UserID, Status, BuildingID, MainFeedbackID, StatusHanding)
                .then(response => {
