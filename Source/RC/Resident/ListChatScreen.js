...
import { ListAllGroupChatPublicinBuilding, GetImageResidentbyUserID, GetInfoUserbyUserId, GetAllGroupResidentByUserID, GetNewestMessageByGroupID } from '../../../APIs/APIclass';
            ...
            <View style={{ flex: 1, paddingBottom: 98, }}>
                ...
                <View style={styles.up}>
                    ...
                    <TouchableOpacity style={{left: WIDTH * 0.9, top: HEIGHT * 0.01}}
                        onPress={() => this.props.navigation.navigate('CreateGroupChatScreenResident', {
                            Token: Token,
                            UserID: UserID,
