...
import { ListAllGroupChatPublicinBuilding, GetNewestMessageByGroupID } from '../../../APIs/APIclass';
...
export default class ListChatPublicGroup extends React.Component {
    _isMounted = false;
    ...
    refreshDataFromServer = () => {
        ...
        ListAllGroupChatPublicinBuilding(BuildingID).then(res => {
