...
import { GetSingleSuperviorbyBuildingID, AddFeedback, GetSingleAdminbyBuildingID, ListAllFeedbackbyReceiverID } from '../../../APIs/APIclass';
            ...
            return (
                <View style={{
                    ...
                    <TouchableOpacity onPress={() =>
                        this.props.navigation.navigate('FeedbackReplyScreenSV', {
                            NameInfo: NameInfo,
                            UserID: UserID,
...
export default class Feedback extends React.Component {
    ...
    refreshDataFromServer = () => {
        ...
        ListAllFeedbackbyReceiverID(this.state.supervisorID, 2024).then(res => {
