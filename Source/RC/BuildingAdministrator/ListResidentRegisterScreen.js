...
import { ListAllResidentRegisterMember, GetImageResidentbyUserID, ListAllResidentbyBuildingID, GetInfoUserbyUserId } from '../../../APIs/APIclass';
...
export default class ListResident extends React.Component {
    ...
    refreshDataFromServer = () => {
        ...
        ListAllResidentRegisterMember(BuildingID, Token)
            .then(res => {
                //if (res.toString() !== "false") {
